...
import StudentPaymentsDashboard from "./components/Payment/StudentPaymentsDashboard";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/PaymentManagementDashboard"
          element={<R_AdminDashboard initialSection="payments" />}
        />
        <Route
        ...
        <Route path="/payments" element={<StudentPaymentsDashboard />} />
